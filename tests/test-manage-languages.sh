...
assert_contains "$output" '--all-known-browser-profiles' "google help should show all-known-browser-profiles support"
...
assert_contains "$output" '--all-known-browser-profiles' "atlassian help should show all-known-browser-profiles support"
...
assert_contains "$output" "Browser profile: default" "atlassian all-known-browser-profiles should print the first profile heading"
assert_contains "$output" "Browser profile: work" "atlassian all-known-browser-profiles should print the second profile heading"
assert_contains "$output" "Browser profile: personal" "atlassian all-known-browser-profiles should print the third profile heading"
...
rm -f "$google_helper_log"
output="$(GOOGLE_ACCOUNT_LANGUAGE_HELPER="$google_helper_stub" GOOGLE_ACCOUNT_HELPER_LOG="$google_helper_log" "$script" google --all-known-browser-profiles "Czech")"
assert_contains "$output" "Browser profile: default" "google all-known-browser-profiles should print the first profile heading"
assert_contains "$output" "Browser profile: work" "google all-known-browser-profiles should print the second profile heading"
assert_contains "$output" "Browser profile: personal" "google all-known-browser-profiles should print the third profile heading"
assert_contains "$(cat "$google_helper_log")" $'write\tdefault\nCzech\nEnglish\nwrite\twork\nCzech\nEnglish\nwrite\tpersonal\nCzech\nEnglish' "google all-known-browser-profiles should write to every known profile"

rm -f "$google_helper_log"
output="$(GOOGLE_ACCOUNT_LANGUAGE_HELPER="$google_helper_stub" GOOGLE_ACCOUNT_HELPER_LOG="$google_helper_log" MACOS_APP_LANGUAGE_INHERIT=$'de-CZ\ncs-CZ' "$script" google --all-known-browser-profiles --dry-run --inherit-macos)"
assert_contains "$output" "Browser profile: default" "google all-known-browser-profiles inheritance should print the first profile heading"
assert_contains "$output" "Browser profile: work" "google all-known-browser-profiles inheritance should print the second profile heading"
assert_contains "$output" "Browser profile: personal" "google all-known-browser-profiles inheritance should print the third profile heading"
assert_contains "$output" $'New Google Account preferred languages:\n  German\n  Czech' "google all-known-browser-profiles inheritance should keep per-profile inherited ordering isolated"
