...
safari_tabs_db_override="${ATLASSIAN_ACCOUNT_SAFARI_TABS_DB:-}"
browser_profiles_override="${ATLASSIAN_ACCOUNT_BROWSER_PROFILES:-}"
browser_profile_menu_data_override="${ATLASSIAN_ACCOUNT_BROWSER_PROFILE_MENU_DATA:-}"
browser_profile_menu_items_override="${ATLASSIAN_ACCOUNT_BROWSER_PROFILE_MENU_ITEMS:-}"
