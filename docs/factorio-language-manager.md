...
This document describes how the Factorio module behind `manage-languages.sh` reads and writes Factorio language settings on macOS, where the language is stored, and how locale identifiers are validated.
